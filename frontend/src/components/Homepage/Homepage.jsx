...
const Homepage = () => {
    ...
    useEffect(() => {
        ...
        async function getPopularProduct() {
            setLoading(true);
            const res = await axios({
                url: "http://localhost:8080/api/product/v1/show-popular-products",
                withCredentials: true,
                method: "GET",
            });
            return res;
        ...
        async function getProduct() {
            setLoading(true);
            const res = await axios({
                url: "http://localhost:8080/api/product/v1/show-all-products",
                withCredentials: true,
                method: "GET",
            });
            return res;
        ...
        async function checkProductInCart() {
            setLoading(true);
            const res = await axios({
                url: "http://localhost:8080/api/product/v1/contain-product-in-cart",
                withCredentials: true,
                method: "POST",
                data: {
    ...
    const handleClickSearchProduct = async () => {
        ...
        try {
            const res = await axios({
                url: "http://localhost:8080/api/product/v1/filter-product-by-name",
                method: "POST",
                withCredentials: true,
                data: {
    ...
    const handleClickProduct = (e) => {
        ...
        async function addPopularProduct() {
            const res = await axios({
                url: "http://localhost:8080/api/product/v1/add-to-popular-product",
                method: "POST",
                withCredentials: true,
                data: {
    ...
    const handleClickPopularProduct = (e) => {
        ...
        async function getPopularProductByName() {
            const res = await axios({
                url: "http://localhost:8080/api/product/v1/get-popular-product-by-name",
                method: "POST",
                withCredentials: true,
                data: {
